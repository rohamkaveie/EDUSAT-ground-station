...
class GroundStationController(QObject):
    ...
    def connect_serial(self, port: str, baudrate: int):
        ...
        try:
            ...
            self.receiver_thread = ReceiverThread(self.serial_interface, self.telemetry_processor)
    ...
    def _handle_parsed_packet(self, packet: dict):
        ...
        # Send to View
        self.packet_parsed.emit(packet)
        # Send to InfluxDB
    ...
    def handle_server_command(self, command: dict):
        ...
        try:
            ...
            full_packet = b'\xC0\xC0' + cmd_id.to_bytes(2, 'big') + payload + b'\x0D'
